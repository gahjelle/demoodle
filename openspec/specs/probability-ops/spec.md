...
Probability operations on Tensors: computing probability distributions (`softmax`),
cumulative sums (`cumsum`), and sampling from categorical distributions (`multinomial`).
These are foundational primitives for autoregressive text generation.
