...
TBD — documents the pretrain training stage, which trains any architecture using cross-entropy loss and Adam, integrates with the Runner and Artifact Cache, and produces a base policy and training metrics.
