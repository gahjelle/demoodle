...
Tensor creation functions for constructing, converting, and combining `Tensor` objects.
These factory functions provide the primary interface for creating tensors from Python
data structures, generating constant or range tensors, and combining existing tensors.
